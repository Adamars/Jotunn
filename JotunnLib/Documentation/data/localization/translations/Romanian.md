...
|$enemy_charred_archer|Arcaș pârlit|
|$enemy_charred_grunt|Soldat pârlit|
...
|$enemy_charred_twitcher|Twitcher pârlit|
|$enemy_charred_twitcher_summoned|Twitcher invocat|
...
|$item_barrelrings|Cercuri de butoi|
|$item_barrelrings_description|Aceste inele metalice sunt perfect rotunde, potrivite pentru a ține un butoi împreună. Doar adaugă lemn!|
...
|$item_bellfragment_description|Acest fragment antic pare a fi o bucată dintr-un clopot spart...|
...
|$settings_hoverselectspd|Viteză selecție la planare|
|$settings_hoverselectspd_descr|Cât de repede este selectat un element când planezi peste el. Setează pe Oprit pentru a dezactiva selecția la planare.|
